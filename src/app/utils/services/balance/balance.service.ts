    ...
    switch (error.status) {
      case 400:
        this._translateService
          .get('The balance is not registered in the system !')
      ...
      case 409:
        this._translateService
          .get('Such a balance is already registered in the system !')
          .subscribe((value) => (errorMessage = value));
        break;
      case 417:
        this._translateService
          .get('Please enter correct balance information !')
          .subscribe((value) => (errorMessage = value));
        break;
      case 404:
        this._translateService
          .get('No balance record found in the system !')
          .subscribe((value) => (errorMessage = value));
        break;
      default:
        this._translateService
